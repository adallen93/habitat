  ...
  if (!hasData) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        ...
        <h2 className="text-xl font-semibold text-stone-700 mb-2">No history yet</h2>
        <p className="text-stone-400 text-sm">Complete your first check-in to start tracking progress.</p>
      </div>
    );
  }
